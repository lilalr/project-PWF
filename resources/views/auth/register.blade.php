<x-guest-layout>
    ...
    <div class="mb-8 text-center sm:text-left">
        <h2 class="text-3xl font-serif font-light text-[#2E2C2A]">Buat Akun</h2>
        <p class="text-xs text-[#7A7570] mt-1 font-light">Daftarkan akun personal Anda untuk berbelanja parfum pilihan.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <div class="flex flex-col">
            <label for="name" class="text-xs uppercase tracking-wider text-[#2E2C2A] font-semibold">Nama Lengkap</label>
        ...
        <!-- Email Address -->
        <div class="flex flex-col">
            <label for="email" class="text-xs uppercase tracking-wider text-[#2E2C2A] font-semibold">Alamat Email</label>
        ...
        <!-- Password -->
        <div class="flex flex-col">
            <label for="password" class="text-xs uppercase tracking-wider text-[#2E2C2A] font-semibold">Kata Sandi</label>
        ...
        <!-- Confirm Password -->
        <div class="flex flex-col">
            <label for="password_confirmation" class="text-xs uppercase tracking-wider text-[#2E2C2A] font-semibold">Konfirmasi Kata Sandi</label>
