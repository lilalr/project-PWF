<x-guest-layout>
    ...
    <div class="mb-8 text-center sm:text-left">
        <h2 class="text-3xl font-serif font-light text-[#2E2C2A]">Login</h2>
        <p class="text-xs text-[#7A7570] mt-1 font-light">Masuk ke akun Liora Fragrance Anda.</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="flex items-center">
            ...
            <label for="remember_me" class="ms-2 text-xs text-[#7A7570] font-light">Ingat saya</label>
        </div>
