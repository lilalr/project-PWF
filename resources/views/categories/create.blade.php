            ...
            <div class="bg-white border border-[#EFEAE2] rounded-sm overflow-hidden">
                <div class="p-8">
                    <div class="text-center mb-8">
                        ...
                        <h3 class="text-lg font-serif font-medium text-[#2E2C2A]">Kategori Aroma Baru</h3>
                        <p class="text-xs text-[#7A7570] font-light mt-1">Tambahkan kategori baru untuk mengatur koleksi parfum Anda</p>
                    </div>
                    ...
                    <form action="{{ route('categories.store') }}" method="POST">
                        ...
                        <div class="mb-8">
                            ...
                            <input type="text" name="name" id="name" class="w-full px-4 py-3 rounded-sm border border-[#EFEAE2] focus:border-[#2E2C2A] focus:ring-0 bg-[#F9F6F0]/50 text-[#2E2C2A] placeholder-gray-400 text-sm transition-all duration-200" placeholder="Contoh: Eau de Parfum, Eau de Toilette..." required>
                            @error('name')
