            ...
            <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-purple-100/50 overflow-hidden">
                ...
                <div class="p-8">
                    <div class="text-center mb-8">
                        ...
                        <p class="text-sm text-gray-400 mt-1">Update the details for "{{ $category->name }}"</p>
                    </div>
                    ...
                    <form action="{{ route('categories.update', $category->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" class="w-full px-4 py-3 rounded-xl border border-purple-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all duration-200 bg-white/50" required>
                            @error('name')
