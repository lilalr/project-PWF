            ...
            <div class="bg-white border border-[#EFEAE2] rounded-sm overflow-hidden">
                <div class="p-8">
                    <div class="text-center mb-8">
                        ...
                        <h3 class="text-lg font-serif font-medium text-[#2E2C2A]">Edit Category</h3>
                        <p class="text-xs text-[#7A7570] font-light mt-1">Update the details for "{{ $category->name }}"</p>
                    </div>
